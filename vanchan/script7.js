    ...
    nextButton.addEventListener("click", function() {
        ...
        foundPatternValues.forEach(section => {
            ...
            totalScores.push({
                ...
                sectionName: section.PatternName,
        ...
        // Chuyển JSON Object thành JSON mảng cho Page 4    
            ...
            var Page5_convertSheet=JSONmanyTo1(thongTinPage5); 
            var Page6_convertSheet=JSONmanyTo1(thongTinPage6);
            //
            thongTinPage5.sort((a, b) => parseFloat(b.totalScore) - parseFloat(a.totalScore));
            thongTinPage6.sort((a, b) => parseFloat(b.totalScore) - parseFloat(a.totalScore));


            var Page5_convert={"page5": thongTinPage5}
            var Page6_convert={"page6": thongTinPage6}
            ...
            // Biến đổi chuỗi JSON thành mảng đối tượng JSON
var thongtinpage7Array = thongTinPage7;

// Tạo biến mảng JSON với tên "thongtinpage7" và một phần tử
var chandoansobo = {
  "chandoansobo": thongtinpage7Array
};

// Hiển thị biến mảng JSON trong console
console.log(chandoansobo);
          ...
          //Lưu để gửi sheet
            var finalJSONarraySheet= Object.assign({},thongTinPage1,thongTinPage2_3,thongTinPage4,Page5_convertSheet,Page6_convertSheet,chanDoanIdJSON,chanDoanScoreJSON);
           var finalJSONSheet= JSON.stringify(finalJSONarraySheet);

           // Lưu để lưu trữ
           var finalJSONarray= Object.assign({},thongTinPage1,thongTinPage2_3,thongTinPage4,Page5_convert,Page6_convert,chandoansobo);
